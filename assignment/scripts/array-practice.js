...
let favoriteFoods = [ 'chicken', 'steak', 'tea'];
console.log( 'Foods:' , favoriteFoods);
...
console.log('second animal is' , favoriteFoods[1])

// 3.b. TODO: Log the last animal in the array using it's array index 
console.log(' third animal' , favoriteFoods[2]);
